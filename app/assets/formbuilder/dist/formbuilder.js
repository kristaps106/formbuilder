    ...
    BuilderView.prototype.bindWindowScrollEvent = function() {
      ...
      return $(window).on('scroll', function() {
        ...
        return _this.$fbLeft.css({
          'margin-top': Math.min(maxMargin, newMargin) + 50
        });
      });
    };
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = 'Nenosaukts';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>Pievienot jaunu elementu</a></li>\n    <li><a data-target=\'#editField\'>Labot elementu</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    ' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-save-wrapper\'>\n  <button style=\'display:none;\' class=\'js-save-form ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'\'></button>\n</div>';
