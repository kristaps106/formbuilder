...
module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    distFolder: '../../../public/assets/formbuilder'
    vendorFolder: '../../../public/assets/formbuilder'
    testFolder: 'test'
    ...
    concat:
      all:
        files:
          ...
          '<%= vendorFolder %>/js/underscore-min.map': './bower_components/underscore/underscore-min.map'
      mobile_friendly:
        files:
          '<%= distFolder %>/formbuilder.js': '<%= compiledFolder %>/*.js'
